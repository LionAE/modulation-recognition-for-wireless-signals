...
class transmitter_qam16(transmitter_mapper):
    ...
    def __init__(self):
        transmitter_mapper.__init__(self, mapper.QAM16, [2, 6, 14, 10, 3, 7, 15, 11, 1, 5, 13, 9, 0, 4, 12, 8], "transmitter_qam16", sps, ebw)
...
class transmitter_gfsk(gr.hier_block2):
    ...
    def __init__(self):
        gr.hier_block2.__init__(self, "transmitter_gfsk", gr.io_signature(1, 1, gr.sizeof_char), gr.io_signature(1, 1, gr.sizeof_gr_complex))
